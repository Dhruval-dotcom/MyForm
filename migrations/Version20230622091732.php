 ...
 */
final class Version20230622091732 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE formdata DROP content, CHANGE created_at created_at DATETIME NOT NULL');
    }
    ...
    public function down(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE formdata ADD content VARCHAR(255) NOT NULL, CHANGE created_at created_at DATETIME DEFAULT NULL');
